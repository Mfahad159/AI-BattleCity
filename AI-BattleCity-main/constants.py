...
TITLE_BAR_HEIGHT = 30
WINDOW_WIDTH   = GRID_SIZE * TILE_SIZE + 240   # +240 for detailed HUD sidebar
...
# Primary Surface Colors (Soft Aesthetic)
BG_PRIMARY        = (40,  35,  50)     # Soft dark lavender
BG_SECONDARY      = (50,  45,  60)     # Soft dark slate
BG_SURFACE        = (60,  55,  75)     # Soft card surface
BG_ELEVATED       = (70,  65,  85)     # Soft hover states

# Grid overlay (RGBA — very subtle)
GRID_LINE_COLOR   = (255, 255, 255, 12)

# Soft Aesthetic Accents
CYAN              = (200, 240, 230)    # Soft mint/periwinkle - Player, UI highlights
CYAN_DIM          = (150, 190, 180)
AMBER             = (255, 200, 140)    # Soft peach - Enemy tanks, warnings
AMBER_DIM         = (200, 150, 90)
RED_HOT           = (240, 150, 150)    # Soft coral - Boss, destruction, game over
RED_DIM           = (180, 100, 100)
MINT              = (180, 240, 200)    # Soft mint - Power-ups, success
MINT_DIM          = (120, 180, 140)
PURPLE            = (220, 180, 240)    # Soft lavender - Boss phase accent
PURPLE_DIM        = (170, 130, 190)
...
# UI Text Colors
TEXT_PRIMARY      = (230, 220, 240)    # Soft lavender tint
TEXT_SECONDARY    = (160, 150, 170)    # Muted soft
TEXT_ACCENT       = CYAN
TEXT_DANGER       = RED_HOT
TEXT_SUCCESS      = MINT
TEXT_DISABLED     = (120, 110, 130)

# Effects (Soft Aesthetic)
BRICK_HIT_FLASH   = (255, 180, 140)    # Soft coral flash
BRICK_CRUMBLE     = (140, 100, 70)     # Soft brown crumble
